  ...
  const tubes = {
    ...
    Draw() {
      tubes.doubles.forEach(function (double) {
        ...
        context.drawImage(
          sprites,
          tubes.ground.SpriteX,
          tubes.ground.SpriteY,
          tubes.Width,
          tubes.Height,
          groundTubeX,
          groundTubeY,
...
//Score based in the game frametime
...
//Screen Changer and screen configs(Draws, Updates and clicks)
...
//Ending and calling main functions...
